  ...
  return (
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.grid}>
        <TouchableOpacity
          style={styles.card}
          onPress={() => handleNavigationToScreen('RegisterAgent')}>
        ...
        <TouchableOpacity
          style={styles.card}
          onPress={() => handleNavigationToScreen('AddedProductsList')}>
          <MaterialCommunityIcons
            name="plus-circle"
            size={30}
            color="black"
        ...
        <TouchableOpacity
          style={styles.card}
          onPress={() => handleNavigationToScreen('AssignScreen')}>
          <MaterialCommunityIcons
        ...
        <TouchableOpacity
          style={styles.card}
          onPress={() => handleNavigationToScreen('View')}>
          <MaterialCommunityIcons
            name="file-document"
            size={30}
            color="black"
